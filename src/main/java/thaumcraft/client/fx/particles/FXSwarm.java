...
public class FXSwarm extends Particle
{
    ...
    public void func_180434_a(final BufferBuilder wr, final Entity entity, final float f, final float f1, final float f2, final float f3, final float f4, final float f5) {
        ...
        final int part = 7 + this.field_70546_d % 8;
        ...
        final float var13 = (float)(this.field_187123_c + (this.field_187126_f - this.field_187123_c) * f - FXSwarm.field_70556_an);
        final float var14 = (float)(this.field_187124_d + (this.field_187127_g - this.field_187124_d) * f - FXSwarm.field_70554_ao);
        final float var15 = (float)(this.field_187125_e + (this.field_187128_h - this.field_187125_e) * f - FXSwarm.field_70555_ap);
    ...
    public void func_189213_a() {
        ...
        if (FXSwarm.buzzcount.size() < 3 && this.field_187136_p.nextInt(50) == 0 && this.field_187122_b.func_184137_a(this.field_187126_f, this.field_187127_g, this.field_187128_h, 8.0, false) != null) {
