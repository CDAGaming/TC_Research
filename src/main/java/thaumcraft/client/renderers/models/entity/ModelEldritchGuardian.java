...
public class ModelEldritchGuardian extends ModelBase
{
    ...
    public ModelEldritchGuardian() {
        ...
        (this.Chestplate = new ModelRenderer((ModelBase)this, 56, 45)).func_78789_a(-4.0f, 1.0f, -4.0f, 8, 7, 2);
        ...
        (this.HoodEye = new ModelRenderer((ModelBase)this, 0, 0)).func_78789_a(-4.0f, -8.0f, -4.0f, 8, 8, 8);
        ...
        (this.Hood1 = new ModelRenderer((ModelBase)this, 40, 12)).func_78789_a(-4.0f, -8.0f, -4.0f, 8, 8, 8);
        ...
        (this.Hood2 = new ModelRenderer((ModelBase)this, 36, 28)).func_78789_a(-3.5f, -8.7f, 2.0f, 7, 7, 3);
        this.Hood2.func_78787_b(128, 64);
        this.Hood2.field_78809_i = true;
        this.setRotation(this.Hood2, -0.2268928f, 0.0f, 0.0f);
        (this.Hood3 = new ModelRenderer((ModelBase)this, 22, 19)).func_78789_a(-3.0f, -9.0f, 2.5f, 6, 6, 3);
        this.Hood3.func_78787_b(128, 64);
        this.Hood3.field_78809_i = true;
        this.setRotation(this.Hood3, -0.3490659f, 0.0f, 0.0f);
        (this.Hood4 = new ModelRenderer((ModelBase)this, 40, 4)).func_78789_a(-2.5f, -9.7f, 3.5f, 5, 5, 3);
        ...
        (this.ShoulderplateTopR = new ModelRenderer((ModelBase)this, 110, 37)).func_78789_a(-5.5f, -2.5f, -3.5f, 2, 1, 7);
        ...
        (this.ShoulderplateR1 = new ModelRenderer((ModelBase)this, 110, 45)).func_78789_a(3.5f, -1.5f, -3.5f, 1, 4, 7);
        ...
        (this.ShoulderplateR2 = new ModelRenderer((ModelBase)this, 94, 45)).func_78789_a(-3.5f, 1.5f, -3.5f, 1, 3, 7);
        ...
        (this.ShoulderplateR3 = new ModelRenderer((ModelBase)this, 94, 45)).func_78789_a(-2.5f, 3.5f, -3.5f, 1, 3, 7);
        ...
        (this.ArmL1 = new ModelRenderer((ModelBase)this, 72, 8)).func_78789_a(-1.0f, 2.5f, -1.5f, 4, 10, 5);
        ...
        (this.ArmL2 = new ModelRenderer((ModelBase)this, 76, 28)).func_78789_a(-1.0f, 9.5f, 3.5f, 4, 3, 3);
        this.ArmL2.func_78787_b(128, 64);
        this.ArmL2.field_78809_i = true;
        (this.ArmL3 = new ModelRenderer((ModelBase)this, 76, 23)).func_78789_a(-1.0f, 6.5f, 3.5f, 4, 3, 2);
        ...
        (this.ArmR1 = new ModelRenderer((ModelBase)this, 72, 8)).func_78789_a(-3.0f, 2.5f, -1.5f, 4, 10, 5);
        ...
        (this.ArmR2 = new ModelRenderer((ModelBase)this, 76, 28)).func_78789_a(-3.0f, 9.5f, 3.5f, 4, 3, 3);
        this.ArmR2.func_78787_b(128, 64);
        this.ArmR2.field_78809_i = true;
        (this.ArmR3 = new ModelRenderer((ModelBase)this, 76, 23)).func_78789_a(-3.0f, 6.5f, 3.5f, 4, 3, 2);
        ...
        (this.ShoulderplateLtop = new ModelRenderer((ModelBase)this, 110, 37)).func_78789_a(3.5f, -2.5f, -3.5f, 2, 1, 7);
        ...
        (this.ShoulderplateL1 = new ModelRenderer((ModelBase)this, 110, 45)).func_78789_a(-4.5f, -1.5f, -3.5f, 1, 4, 7);
        ...
        (this.ShoulderplateL2 = new ModelRenderer((ModelBase)this, 94, 45)).func_78789_a(2.5f, 1.5f, -3.5f, 1, 3, 7);
        ...
        (this.ShoulderplateL3 = new ModelRenderer((ModelBase)this, 94, 45)).func_78789_a(1.5f, 3.5f, -3.5f, 1, 3, 7);
        ...
        (this.LegpanelR4 = new ModelRenderer((ModelBase)this, 0, 43)).func_78789_a(-3.0f, 0.5f, -3.5f, 2, 3, 1);
        ...
        (this.LegpanelR5 = new ModelRenderer((ModelBase)this, 0, 47)).func_78789_a(-3.0f, 2.5f, -2.5f, 2, 3, 1);
        ...
        (this.LegpanelR6 = new ModelRenderer((ModelBase)this, 6, 43)).func_78789_a(-3.0f, 4.5f, -1.5f, 2, 3, 1);
        ...
        (this.BackpanelR1 = new ModelRenderer((ModelBase)this, 0, 18)).func_78789_a(-3.0f, 0.5f, 2.5f, 5, 3, 1);
        ...
        (this.BackpanelR2 = new ModelRenderer((ModelBase)this, 0, 18)).func_78789_a(-3.0f, 2.5f, 1.5f, 5, 3, 1);
        ...
        (this.BackpanelR3 = new ModelRenderer((ModelBase)this, 0, 18)).func_78789_a(-3.0f, 4.5f, 0.5f, 5, 3, 1);
        ...
        (this.BackpanelL3 = new ModelRenderer((ModelBase)this, 0, 18)).func_78789_a(-2.0f, 4.5f, 0.5f, 5, 3, 1);
        ...
        (this.LegpanelL4 = new ModelRenderer((ModelBase)this, 0, 43)).func_78789_a(1.0f, 0.5f, -3.5f, 2, 3, 1);
        ...
        (this.LegpanelL5 = new ModelRenderer((ModelBase)this, 0, 47)).func_78789_a(1.0f, 2.5f, -2.5f, 2, 3, 1);
        ...
        (this.LegpanelL6 = new ModelRenderer((ModelBase)this, 6, 43)).func_78789_a(1.0f, 4.5f, -1.5f, 2, 3, 1);
        ...
        (this.BackpanelL1 = new ModelRenderer((ModelBase)this, 0, 18)).func_78789_a(-2.0f, 0.5f, 2.5f, 5, 3, 1);
        ...
        (this.BackpanelL2 = new ModelRenderer((ModelBase)this, 0, 18)).func_78789_a(-2.0f, 2.5f, 1.5f, 5, 3, 1);
        ...
        (this.SidepanelL1 = new ModelRenderer((ModelBase)this, 0, 22)).func_78789_a(1.5f, 0.5f, -2.5f, 1, 4, 5);
        ...
        (this.SidepanelR1 = new ModelRenderer((ModelBase)this, 0, 22)).func_78789_a(-2.5f, 0.5f, -2.5f, 1, 4, 5);
        ...
        (this.SidepanelR2 = new ModelRenderer((ModelBase)this, 0, 54)).func_78789_a(0.0f, 0.0f, -0.5f, 1, 5, 5);
        ...
        (this.SidepanelR3 = new ModelRenderer((ModelBase)this, 0, 35)).func_78789_a(0.0f, 0.0f, -0.5f, 1, 3, 5);
        ...
        (this.SidepanelR4 = new ModelRenderer((ModelBase)this, 24, 35)).func_78789_a(0.0f, 0.0f, -0.5f, 1, 3, 5);
        ...
        (this.SidepanelL2 = new ModelRenderer((ModelBase)this, 0, 54)).func_78789_a(0.0f, 0.0f, -0.5f, 1, 5, 5);
        ...
        (this.SidepanelL3 = new ModelRenderer((ModelBase)this, 0, 35)).func_78789_a(0.0f, 0.0f, -0.5f, 1, 3, 5);
        ...
        (this.SidepanelL4 = new ModelRenderer((ModelBase)this, 24, 35)).func_78789_a(0.0f, 0.0f, -0.5f, 1, 3, 5);
        ...
        (this.LegpanelC1 = new ModelRenderer((ModelBase)this, 16, 45)).func_78789_a(-3.0f, 0.0f, -0.5f, 6, 8, 1);
        ...
        (this.LegpanelC2 = new ModelRenderer((ModelBase)this, 16, 54)).func_78789_a(-3.0f, 0.0f, -0.5f, 6, 4, 1);
        ...
        (this.LegpanelC3 = new ModelRenderer((ModelBase)this, 32, 59)).func_78789_a(-3.0f, 0.0f, -0.5f, 6, 4, 1);
        ...
        (this.Cloak1 = new ModelRenderer((ModelBase)this, 106, 0)).func_78789_a(0.0f, 0.0f, -0.5f, 10, 18, 1);
        ...
        (this.Cloak2 = new ModelRenderer((ModelBase)this, 106, 19)).func_78789_a(0.0f, 0.0f, -0.5f, 10, 4, 1);
        ...
        (this.Cloak3 = new ModelRenderer((ModelBase)this, 106, 24)).func_78789_a(0.0f, 0.0f, -0.5f, 10, 4, 1);
    ...
    public void func_78086_a(final EntityLivingBase p_78086_1_, final float p_78086_2_, final float p_78086_3_, final float p_78086_4_) {
    ...
    public void func_78088_a(final Entity entity, final float f, final float f1, final float f2, final float f3, final float f4, final float f5) {
        ...
        if (entity instanceof EntityEldritchWarden) {
            ...
            final int j = (int)(195.0f + MathHelper.func_76126_a(entity.field_70173_aa / 3.0f) * 15.0f + 15.0f);
            final int k = j % 65536;
            final int l = j / 65536;
