...
public class WavefrontObject implements IModelCustom
{
    ...
    public class TextureCoordinate
    {
        ...
        public TextureCoordinate(final WavefrontObject this$0, final float u, final float v) {
            this(this$0, u, v, 0.0f);
        }
        ...
        public void addFaceForRender(final Tessellator tessellator, final float textureOffset) {
            ...
            for (int j = 0; j < this.vertices.length; ++j) {
                if (this.textureCoordinates != null && this.textureCoordinates.length > 0) {
                    ...
                    tessellator.func_178180_c().func_181662_b((double)this.vertices[j].x, (double)this.vertices[j].y, (double)this.vertices[j].z).func_187315_a((double)(this.textureCoordinates[j].u + offsetU), (double)(this.textureCoordinates[j].v + offsetV)).func_181663_c(this.faceNormal.x, this.faceNormal.y, this.faceNormal.z).func_181675_d();
                }
                else {
                    tessellator.func_178180_c().func_181662_b((double)this.vertices[j].x, (double)this.vertices[j].y, (double)this.vertices[j].z).func_181663_c(this.faceNormal.x, this.faceNormal.y, this.faceNormal.z).func_181675_d();
                }
            }
        }
        
        public Vertex calculateFaceNormal() {
            final Vec3d v1 = new Vec3d((double)(this.vertices[1].x - this.vertices[0].x), (double)(this.vertices[1].y - this.vertices[0].y), (double)(this.vertices[1].z - this.vertices[0].z));
            final Vec3d v2 = new Vec3d((double)(this.vertices[2].x - this.vertices[0].x), (double)(this.vertices[2].y - this.vertices[0].y), (double)(this.vertices[2].z - this.vertices[0].z));
    ...
    public class GroupObject
    {
        ...
        public GroupObject(final WavefrontObject this$0) {
            this(this$0, "");
        }
        
        public GroupObject(final WavefrontObject this$0, final String name) {
            this(this$0, name, -1);
        }
