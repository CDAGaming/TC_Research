...
public class BlocksTC
{
    ...
    public static HashMap<EnumDyeColor, Block> candles;
    public static HashMap<EnumDyeColor, Block> banners;
    ...
    static {
        BlocksTC.candles = new HashMap<EnumDyeColor, Block>();
        BlocksTC.banners = new HashMap<EnumDyeColor, Block>();
        BlocksTC.nitor = new HashMap<EnumDyeColor, Block>();
    }
}
