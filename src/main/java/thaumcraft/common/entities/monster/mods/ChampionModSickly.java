...
public class ChampionModSickly implements IChampionModifierEffect
{
    ...
    public void showFX(final EntityLivingBase boss) {
        ...
        FXDispatcher.INSTANCE.drawGenericParticles(boss.func_174813_aQ().field_72340_a + w, boss.func_174813_aQ().field_72338_b + h, boss.func_174813_aQ().field_72339_c + d, 0.0, -0.02, 0.0, 0.2f, 0.6f + boss.field_70170_p.field_73012_v.nextFloat() * 0.1f, 0.2f + boss.field_70170_p.field_73012_v.nextFloat() * 0.1f, 0.5f, false, 1, 4, 2, 5 + boss.field_70170_p.field_73012_v.nextInt(4), 0, 0.9f + boss.field_70170_p.field_73012_v.nextFloat() * 0.3f, 0.0f, 0);
    }
