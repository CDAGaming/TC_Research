...
public class ChampionModVampire implements IChampionModifierEffect
{
    ...
    public void showFX(final EntityLivingBase boss) {
        ...
        FXDispatcher.INSTANCE.drawGenericParticles(boss.func_174813_aQ().field_72340_a + w, boss.func_174813_aQ().field_72338_b + h, boss.func_174813_aQ().field_72339_c + d, 0.0, 0.0, 0.0, 0.9f + boss.field_70170_p.field_73012_v.nextFloat() * 0.1f, 0.0f, 0.0f, 0.9f, false, 579, 4, 1, 4 + boss.field_70170_p.field_73012_v.nextInt(4), 0, 0.5f + boss.field_70170_p.field_73012_v.nextFloat() * 0.2f, 0.0f, 0);
    }
