...
public class ChampionModGrim implements IChampionModifierEffect
{
    ...
    public void showFX(final EntityLivingBase boss) {
        ...
        FXDispatcher.INSTANCE.drawGenericParticles(boss.func_174813_aQ().field_72340_a + w, boss.func_174813_aQ().field_72338_b + h, boss.func_174813_aQ().field_72339_c + d, 0.0, -0.02, 0.0, boss.field_70170_p.field_73012_v.nextFloat() * 0.2f, boss.field_70170_p.field_73012_v.nextFloat() * 0.2f, boss.field_70170_p.field_73012_v.nextFloat() * 0.2f, 0.8f, false, 640, 10, 1, 8 + boss.field_70170_p.field_73012_v.nextInt(4), 0, 0.6f + boss.field_70170_p.field_73012_v.nextFloat() * 0.4f, 0.0f, 0);
    }
