...
public class CCRenderState
{
    ...
    public static void pushLightmap() {
        OpenGlHelper.func_77475_a(OpenGlHelper.field_77476_b, (float)(CCRenderState.brightness & 0xFFFF), (float)(CCRenderState.brightness >>> 16));
    }
    ...
    static {
        ...
        CCRenderState.normalAttrib = new VertexAttribute<Vector3[]>() {
            ...
            @Override
            public boolean load() {
                this.normalRef = CCRenderState.model.getAttributes((VertexAttribute<Vector3[]>)this);
        ...
        CCRenderState.colourAttrib = new VertexAttribute<int[]>() {
            ...
            @Override
            public boolean load() {
                this.colourRef = CCRenderState.model.getAttributes((VertexAttribute<int[]>)this);
        ...
        CCRenderState.sideAttrib = new VertexAttribute<int[]>() {
            ...
            @Override
            public boolean load() {
                this.sideRef = CCRenderState.model.getAttributes((VertexAttribute<int[]>)this);
                if (CCRenderState.model.hasAttribute(this)) {
        ...
        CCRenderState.lightCoordAttrib = new VertexAttribute<LC[]>() {
            ...
            @Override
            public boolean load() {
                this.lcRef = CCRenderState.model.getAttributes((VertexAttribute<LC[]>)this);
                if (CCRenderState.model.hasAttribute(this)) {
